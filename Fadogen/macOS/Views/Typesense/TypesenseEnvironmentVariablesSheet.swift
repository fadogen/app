...
/// Sheet displaying Typesense environment variables for Laravel Scout
/// Users can preview and copy .env configuration
struct TypesenseEnvironmentVariablesSheet: View {
    @Environment(\.dismiss) private var dismiss
    @State private var showCopiedConfirmation = false

    /// Typesense connection environment variables
